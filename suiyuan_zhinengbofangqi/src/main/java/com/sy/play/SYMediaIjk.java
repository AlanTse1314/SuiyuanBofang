...
public class SYMediaIjk extends SYMediaInterface implements IMediaPlayer.OnPreparedListener,
    ...
    private static final String TAG = "SYMediaIjk";
    private IjkMediaPlayer ijkMediaPlayer;
    private ITrackInfo[] iTrackInfos;

    public SYMediaIjk(SYplay yplay) {
        super(yplay);
    }
...
//                        ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "max-buffer-size", 60 * 1024 * 1024);
                    ...
                    ijkMediaPlayer.setOnPreparedListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnVideoSizeChangedListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnCompletionListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnErrorListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnInfoListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnBufferingUpdateListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnSeekCompleteListener(SYMediaIjk.this);
                    ijkMediaPlayer.setOnTimedTextListener(SYMediaIjk.this);
//                    ijkMediaPlayer.setOnNativeInvokeListener(SYMediaIjk.this);
    ...
    public boolean onError(IMediaPlayer iMediaPlayer, final int what, final int extra) {
        handler.post(new Runnable() {
            @Override
            public void run() {
                play.onError(SYMediaIjk.class, null, what, extra);
            }
        });
        return true;
    }
    ...
    public void onBufferingUpdate(IMediaPlayer iMediaPlayer, final int percent) {
        handler.post(() -> play.setBufferProgress(percent, SYMediaIjk.class));
    }
