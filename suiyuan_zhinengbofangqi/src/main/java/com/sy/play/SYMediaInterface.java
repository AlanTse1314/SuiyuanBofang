...
import com.sy.play.util.UrlUtil;
 ...
 * 自定义播放器
 */
public abstract class SYMediaInterface implements TextureView.SurfaceTextureListener {
    protected SYplay play;
    public SurfaceTexture SAVED_SURFACE;
    public HandlerThread mMediaHandlerThread;
    public Handler mMediaHandler;
    public Handler handler;
    private static final String TAG = "SYMediaInterface";
    ...
    protected SYDataSource syDataSource;

    public SYMediaInterface(SYplay play) {
        UP(play);
    }

    public void UP(SYplay play) {
        this.play = play;
