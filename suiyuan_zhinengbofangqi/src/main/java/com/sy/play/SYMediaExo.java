...
public class SYMediaExo extends SYMediaInterface implements Player.EventListener, VideoListener, HttpListener {
    private static final String TAG = "SYMediaExo";
    ...
    public SYMediaExo(SYplay sYplay) {
        super(sYplay);
    }
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            try {
                ...
                simpleExoPlayer.addListener(SYMediaExo.this);
                simpleExoPlayer.addVideoListener(SYMediaExo.this);
...
//        Log_e4a.e(TAG, "onLoadingChanged");
    ...
    public void onPlayerError(ExoPlaybackException error) {
        ...
        handler.post(() -> play.onError(SYMediaExo.class, error.getMessage(), 1000, 1000));
    }
    ...
    private class onBufferingUpdate implements Runnable {
        ...
        public void run() {
            if (simpleExoPlayer != null) {
                ...
                handler.post(() -> {
                    play.setBufferProgress(percent, SYMediaExo.class);
                    if (percent <= 100) {
                        handler.post(callback);
                    } else {
