...
import com.sy.play.configure.UIConfigure;
...
public class BottomMain extends FrameLayout implements View.OnClickListener {
    private static final String TAG = "SYplay->BottomMain";
    ...
    private void init(Context context) {
        View v = View.inflate(getContext(), R.layout.sy_layout_std_bottom, this);
        v.findViewById(R.id.gen).setBackgroundResource(R.drawable.sy_bottom_bg);
    ...
    public void setPlayStat(boolean isPlay) {
        btnPlay.setImageResource(isPlay ? R.drawable.sy_pause : R.drawable.sy_play);
    }
        ...
        if (this.windowEnume != null) {
            switch (windowEnume) {
                case TYPE_ORDINARY:
                    ...
                    fullScreen.setImageResource(R.drawable.sy_qp);
                    break;
                ...
                case TYPE_FULL_HORIZONTAL_SCREEN:
                    ...
                    fullScreen.setImageResource(R.drawable.sy_tcqp);
                    break;
