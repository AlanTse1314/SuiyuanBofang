...
import com.sy.play.view.PlayFrameLayout;


public class SYTextureView extends TextureView {
    ...
    private SYplay sYplay;
    public SYTextureView(Context context,SYplay sYplay) {
        super(context);
    ...
    public class ZoomOnTouchListeners implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent motionEvent) {
            ...
            if (view instanceof PlayFrameLayout) {
                ((PlayFrameLayout) view).onTouch((SYTextureView) v, motionEvent);
            }
            return true;
        }
